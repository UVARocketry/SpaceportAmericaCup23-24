...
public:
    ...
    bool begin_I2C(
        uint8_t i2c_addr = LIS3MDL_I2CADDR_DEFAULT, TwoWire* wire = &Wire
    );
    bool begin_SPI(
        uint8_t cs_pin, SPIClass* theSPI = &SPI, uint32_t frequency = 1000000
    );
    bool begin_SPI(
    ...
    void configInterrupt(
        bool enableX, bool enableY, bool enableZ, bool polarity, bool latch,
        bool enableInt
    );
